...
:: 2. Build to the temporary path for Precompile .dll deployment
:: X : ORIGINAL
...
::)
:: O : TRY GET DIRECTORY NAME BY DIR.
:: Because of using Visual Studio, you should ignore several NON-Project folder.
:: .vs can be ignore by .gitignore
:: packages will be generated by nuget and should check.
